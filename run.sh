#!/bin/sh
# vgg L2
#python pruning.py --finetune_epochs 10 --model vgg16 --prune 0.0 --layer all --strategy L1
#python pruning.py --finetune_epochs 10 --model vgg16 --prune 0.05 --layer all --strategy L1
#python pruning.py --finetune_epochs 10 --model vgg16 --prune 0.1 --layer all --strategy L1
#python pruning.py --finetune_epochs 10 --model vgg16 --prune 0.2 --layer all --strategy L1
#python pruning.py --finetune_epochs 10 --model vgg16 --prune 0.3 --layer all --strategy L1
#python pruning.py --finetune_epochs 10 --model vgg16 --prune 0.4 --layer all --strategy L1
#python pruning.py --finetune_epochs 10 --model vgg16 --prune 0.5 --layer all --strategy L1
#python pruning.py --finetune_epochs 10 --model vgg16 --prune 0.6 --layer all --strategy L1
#python pruning.py --finetune_epochs 10 --model vgg16 --prune 0.7 --layer all --strategy L1
#python pruning.py --finetune_epochs 10 --model vgg16 --prune 0.8 --layer all --strategy L1
#python pruning.py --finetune_epochs 10 --model vgg16 --prune 0.9 --layer all --strategy L1
