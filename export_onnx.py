...
parser.add_argument('--model', type=str, default='mobilenetv3', help='mobilenetv1, mobilenetv2, mobilenetv3, or efficientnet')
...
def load_model(model, path=f"checkpoints/mobilenetv3.pt", print_msg=True):
    try:
...
torch.onnx.export(model, random_input, f'./onnx/{model_name}_{prune_val}.onnx', export_params=True, opset_version=10)
